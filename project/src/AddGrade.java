/**
 * Команда за добавяне на оценка на студент по дисциплина.
 *
 * Употреба: grade <факултетен_номер> <дисциплина> <оценка>
 *
 * Студентът трябва вече да е записан в дисциплината.
 */
