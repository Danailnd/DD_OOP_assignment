/**
 * Команда за извеждане на пълна справка за студент.
 *
 * Употреба: print <факултетен_номер>
 *
 * Показва информация за студента, записаните дисциплини, оценки и текущ статус.
 */
