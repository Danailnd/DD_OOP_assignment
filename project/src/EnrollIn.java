/**
 * Команда за записване на студент в конкретна учебна дисциплина.
 *
 * Употреба: enrollin <факултетен_номер> <име_на_дисциплина>
 *
 * Разрешено е само за дисциплини от специалността на студента.
 */
